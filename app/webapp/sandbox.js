...
(function () {
    ...
    function adjustApplicationConfiguration(oConfig) {
        ...
        if (aApplicationKeys.length) {
            ...
            oConfig.groups.forEach(function (x, i) {
                x.tiles = x.tiles.map(function (y, j) {
                    return fnMakeTile(oConfig.applications[y], "" + i + j, y);
                });
                oLaunchPageAdapterConfig.groups.push(x);
            })
